sed -n '1, 388p' ./mn_avg.txt > pos_fold1.txt
sed -n '389, 776p' ./mn_avg.txt > pos_fold2.txt
sed -n '777, 1164p' ./mn_avg.txt > pos_fold3.txt
sed -n '1165, 1552p' ./mn_avg.txt > pos_fold4.txt
sed -n '1553, 1940p' ./mn_avg.txt > pos_fold5.txt
sed -n '1941, 2328p' ./mn_avg.txt > neg_fold1.txt
sed -n '2329, 2716p' ./mn_avg.txt > neg_fold2.txt
sed -n '2717, 3104p' ./mn_avg.txt > neg_fold3.txt
sed -n '3105, 3492p' ./mn_avg.txt > neg_fold4.txt
sed -n '3493, 3880p' ./mn_avg.txt > neg_fold5.txt
